 ...
 * @description Source de vérité unique pour les données des 6 projets.
 *              Utilisé par la page détail pour l'affichage dynamique
 *              et par la page liste pour les liens de démonstration.
 *
 *              Structure d'un projet :
 *              - id         {number}   identifiant unique (correspond à ?id= dans l'URL)
 *              - title      {string}   titre affiché
 *              - slug       {string}   identifiant court pour les liens de démo
 *              - category   {string}   'web' | 'mobile' | 'api'
 *              - categoryLabel {string} libellé affiché
 *              - date       {string}   date de réalisation
 *              - duration   {string}   durée du projet
 *              - status     {string}   'Terminé' | 'En cours' | 'En pause'
 *              - role       {string}   rôle tenu
 *              - image      {string}   chemin de l'image (relatif à la racine)
 *              - demoUrl    {string}   lien vers la démo en ligne
 *              - githubUrl  {string}   lien vers le dépôt GitHub
 *              - shortDesc  {string}   description courte (carte liste)
 *              - description {string[]} paragraphes de la description complète
 *              - features   {string[]} liste des fonctionnalités clés
 *              - learned    {string[]} ce qui a été appris
 *              - stack      {object}   { frontend, backend, tools } — tableaux de strings
 *              - tags       {string[]} badges technos (carte liste)
 *              - ogImage    {string}   image Open Graph (chemin relatif)
 *
 * @version 2.1.0
 */
...
export const PROJECTS = [
  {
    ...
    demoUrl: 'demos/ecommerce/index.html',
    githubUrl: 'https://github.com/seydinalimamoulayeyade',
    ogImage: 'images/projet1.jpg',
    shortDesc: 'Plateforme complète avec catalogue produits, panier, authentification et tableau de bord administrateur.',
    description: [
  ...
  },
  {
    ...
    shortDesc: 'Application web de gestion de tâches quotidiennes avec synchronisation en temps réel.',
    description: [
  ...
  },
  {
    ...
    demoUrl: 'demos/blog/index.html',
    githubUrl: 'https://github.com/seydinalimamoulayeyade',
    ogImage: 'images/projet3.jpg',
    shortDesc: 'Blog moderne avec système de commentaires et partage sur les réseaux sociaux.',
    description: [
  ...
  },
  {
    ...
    demoUrl: 'demos/meteo/index.html',
    githubUrl: 'https://github.com/seydinalimamoulayeyade',
    ogImage: 'images/projet4.jpg',
    shortDesc: 'Application mobile de consultation météo avec géolocalisation et prévisions sur 7 jours.',
    description: [
  ...
  },
  {
    ...
    demoUrl: 'demos/api-users/index.html',
    githubUrl: 'https://github.com/seydinalimamoulayeyade',
    ogImage: 'images/projet5.jpg',
    shortDesc: 'API RESTful sécurisée avec authentification JWT, rôles et permissions.',
    description: [
  ...
  },
  {
    ...
    demoUrl: 'demos/dashboard/index.html',
    githubUrl: 'https://github.com/seydinalimamoulayeyade',
    ogImage: 'images/projet6.jpg',
    shortDesc: 'Tableau de bord de visualisation de données avec graphiques interactifs et exports.',
    description: [
